...
const auth_url = "http://www.strava.com/oauth/authorize?client_id=125102&response_type=code&redirect_uri=http://localhost:3000&approval_prompt=force&scope=activity:read"
